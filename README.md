...
Start with `CLAUDE.md`, then `docs/decisions.md` for the "why did you..." log, `docs/codebase-index.md` for a per-file map of the repo, and `docs/flows.md` for every user-facing flow walked end to end.
